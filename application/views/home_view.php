...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets/css/home_view.css" />  
...
<body>
              ...
              <div class="ch-info-wrap">
                <div class="ch-info">
                  ...
                  <div class="ch-info-back">
                    <p>To showcase your projects & ideas to the world, sign up <a href="<?php echo base_url();?>register/user_registration">HERE</a></p>
                  </div>  
                </div>
              </div>
            </div>
            <br><img src="<?php echo base_url(); ?>/assets/img/ajax-loader.gif">
          </li>
          <li>
            ...
            <div class="ch-item ch-img-3">
              <div class="ch-info-wrap">
                <div class="ch-info">
                  ...
                  <div class="ch-info-back">
                    <p>To help budding enterpreneurs find direction with their start up, sign up <a href="<?php echo base_url();?>register/mentor_registration">HERE</a></p>
                  </div>
                </div>
              </div>
            </div>
  ...
  <script type="text/javascript" src="http://localhost/openfuel/assets/js/shapeshifter.js"></script>

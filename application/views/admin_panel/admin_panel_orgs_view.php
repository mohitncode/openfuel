	...
	<body>
				...
				<?php foreach($organizations as $organization) { ?>
					<div class="large-12 columns event_row">
						<div class="large-1 columns">
							<h3><?php echo $organization['id']; ?></h3>
						</div>
						<div class="large-2 columns">
							<?php
								if($organization['profile_image'] == "not_set") {
									echo '<img src="http://localhost/openfuel/assets/img/default_profile.png" height="100" width="100" />';
								}
								else { ?>
								<img src="<?php echo $organization['profile_image']; ?>" height="100" width="100" />
							<?php } ?>						
						</div>
						
						<div class=" large-7 columns">
							<h3><?php echo $organization['org_name']; ?></h3>
							<p>
								<?php
									$description = substr($organization['about'], 0, 100);
									echo $description ."...";
								?>
							</p>
						</div>
						...
						<div class="large-2 columns">
							<div class="large-1 columns">
								<a class="tiny button approve_event" id="<?php echo $organization['id']; ?>">Approve</a>
							</div>
							<div class="large-1 columns">
		...
		<script type="text/javascript">
			...
			$('.approve_event').click(function() {
				...
				console.log("Organization approval tried. " +org_id);
				$.ajax({
					url: "http://localhost/openfuel/admin/approve_organization/" +org_id
					}).done(function(data, textStatus) {
					if(textStatus = "Organization validated successfully.") {
